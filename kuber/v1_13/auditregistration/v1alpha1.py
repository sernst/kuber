...
class AuditSink(_kuber_definitions.Resource):
    ...
    def create_resource(self, namespace: 'str' = None) -> bool:
        ...
        or not the AuditSink was actually created.
        """
        try:
    ...
    def replace_resource(self, namespace: 'str' = None) -> bool:
        ...
        configured Kubernetes cluster and returns a boolean indicating whether
        or not the AuditSink was actually replaced.
        """
        try:
    ...
    def delete_resource(self, namespace: 'str' = None) -> bool:
        """
        Deletes the AuditSink from the currently
...
class AuditSinkList(_kuber_definitions.Resource):
    """
    ...
    def create_resource(self, namespace: 'str' = None) -> bool:
        """
        Creates the AuditSinkList in the currently
        configured Kubernetes cluster and returns a boolean indicating whether
        or not the AuditSinkList was actually created.
        """
        try:
            _kube_api.create_resource(self, namespace=namespace)
            return True
    ...
    def replace_resource(self, namespace: 'str' = None) -> bool:
        """
        Replaces the AuditSinkList in the currently
        configured Kubernetes cluster and returns a boolean indicating whether
        or not the AuditSinkList was actually replaced.
        """
        try:
            _kube_api.replace_resource(self, namespace=namespace)
            return True
    ...
    def delete_resource(self, namespace: 'str' = None) -> bool:
        """
        Deletes the AuditSinkList from the currently
        configured Kubernetes cluster and returns the status information
        returned by the Kubernetes API in response to the delete action.
        """
        try:
