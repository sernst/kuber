...
from kuber.v1_23.batch_v1 import JobSpec  # noqa: F401
...
from kuber.v1_23.core_v1 import ObjectReference  # noqa: F401
...
class CronJobStatus(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(CronJobStatus, self).__init__(
            api_version="batch/v1beta1", kind="CronJobStatus"
        )
        self._properties = {
...
class JobTemplateSpec(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(JobTemplateSpec, self).__init__(
            api_version="batch/v1beta1", kind="JobTemplateSpec"
        )
        self._properties = {
            "metadata": metadata if metadata is not None else ObjectMeta(),
