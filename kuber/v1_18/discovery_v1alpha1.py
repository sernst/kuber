...
class Endpoint(_kuber_definitions.Definition):
    ...
    def addresses(self) -> typing.List[str]:
        ...
        networking where both IPv4 and IPv6 addresses would be
        included with the IP addressType. Consumers (e.g. kube-
        proxy) must handle different types of addresses in the
        context of their own capabilities. This must contain at
        least one address but no more than 100.
        """
...
class EndpointSlice(_kuber_definitions.Resource):
    ...
    def address_type(self) -> str:
        ...
        type. The following address types are currently supported: *
        IP:   Represents an IP Address. This can include both IPv4
        and IPv6
                addresses.
        * FQDN: Represents a Fully
        Qualified Domain Name. Default is IP
        """
