...
from kuber.v1_24.batch_v1 import JobSpec  # noqa: F401
...
class CronJobSpec(_kuber_definitions.Definition):
    ...
    def time_zone(self) -> str:
        """
        The time zone for the given schedule, see https://en.wikiped
        ia.org/wiki/List_of_tz_database_time_zones. If not
        specified, this will rely on the time zone of the kube-
        controller-manager process. ALPHA: This field is in alpha
