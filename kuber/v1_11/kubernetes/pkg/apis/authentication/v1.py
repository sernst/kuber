...
class TokenReview(_kuber_definitions.Definition):
    ...
    io.k8s.api.authentication.v1.TokenReview instead.
    """
...
class TokenReviewSpec(_kuber_definitions.Definition):
    """
    Deprecated. Please use
    io.k8s.api.authentication.v1.TokenReviewSpec instead.
    """
...
class TokenReviewStatus(_kuber_definitions.Definition):
    """
    Deprecated. Please use
    io.k8s.api.authentication.v1.TokenReviewStatus instead.
    """
...
class UserInfo(_kuber_definitions.Definition):
    """
    Deprecated. Please use io.k8s.api.authentication.v1.UserInfo
    instead.
    """
