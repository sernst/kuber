...
class ServerStorageVersion(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(ServerStorageVersion, self).__init__(
            ...
            kind='ServerStorageVersion'
        )
        self._properties = {
            'apiServerID': api_server_id if api_server_id is not None else '',
            'decodableVersions': decodable_versions if decodable_versions is not None else [],
    ...
    def api_server_id(self) -> str:
        ...
        """
        return self._properties.get('apiServerID')
    ...
    def decodable_versions(self) -> typing.List[str]:
        ...
        decodableVersions.
        """
        return self._properties.get('decodableVersions')
    ...
    def encoding_version(self) -> str:
        ...
        """
        return self._properties.get('encodingVersion')
...
class StorageVersion(_kuber_definitions.Resource):
    ...
    def spec(self, value: typing.Union['StorageVersionSpec', dict]):
        ...
        """
        if isinstance(value, dict):
            value = StorageVersionSpec().from_dict(value)
    ...
    def status(self, value: typing.Union['StorageVersionStatus', dict]):
        ...
        """
        if isinstance(value, dict):
            value = StorageVersionStatus().from_dict(value)
    ...
    def create_resource(
        ...
        """
        names = [
            'create_namespaced_storage_version',
    ...
    def replace_resource(
        ...
        """
        names = [
            'replace_namespaced_storage_version',
    ...
    def patch_resource(
        ...
        """
        names = [
            'patch_namespaced_storage_version',
...
class StorageVersionList(_kuber_definitions.Collection):
    ...
    def items(
            self,
            value: typing.Union[typing.List['StorageVersion'], typing.List[dict]]
    ):
        """
        ...
        for item in value:
            if isinstance(item, dict):
                item = StorageVersion().from_dict(item)
            cleaned.append(item)
...
class StorageVersionStatus(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(StorageVersionStatus, self).__init__(
            api_version='apiserverinternal/v1alpha1',
            kind='StorageVersionStatus'
        )
        self._properties = {
            'commonEncodingVersion': common_encoding_version if common_encoding_version is not None else '',
    ...
    def common_encoding_version(self) -> str:
        ...
        with the reality.
        """
        return self._properties.get('commonEncodingVersion')
    ...
    def conditions(
        ...
        for item in value:
            if isinstance(item, dict):
                item = StorageVersionCondition().from_dict(item)
            cleaned.append(item)
    ...
    def storage_versions(self) -> typing.List['ServerStorageVersion']:
        ...
        """
        return self._properties.get('storageVersions')
    ...
    def storage_versions(
        ...
        for item in value:
            if isinstance(item, dict):
                item = ServerStorageVersion().from_dict(item)
            cleaned.append(item)
