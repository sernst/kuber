...
from kuber.v1_14.core.v1 import Container
from kuber.v1_14.core.v1 import ContainerPort
from kuber.v1_14.core.v1 import EnvFromSource
from kuber.v1_14.core.v1 import EnvVar
from kuber.v1_14.batch.v1 import JobSpec
from kuber.v1_14.core.v1 import Lifecycle
...
from kuber.v1_14.core.v1 import ObjectReference
from kuber.v1_14.core.v1 import Probe
from kuber.v1_14.core.v1 import ResourceRequirements
from kuber.v1_14.core.v1 import SecurityContext
from kuber.v1_14.core.v1 import VolumeDevice
from kuber.v1_14.core.v1 import VolumeMount
...
class CronJob(_kuber_definitions.Resource):
    ...
    def get_resource_status(
        ...
        return CronJobStatus().from_dict(status)

    def delete_resource(self, namespace: 'str' = None) -> bool:
        """
        Deletes the CronJob from the currently
        configured Kubernetes cluster and returns the status information
...
class CronJobList(_kuber_definitions.Resource):
    """
    ...
    def create_resource(self, namespace: 'str' = None) -> bool:
        """
        Creates the CronJobList in the currently
        configured Kubernetes cluster and returns a boolean indicating whether
        or not the CronJobList was actually created.
        """
        try:
            _kube_api.create_resource(self, namespace=namespace)
            return True
    ...
    def replace_resource(self, namespace: 'str' = None) -> bool:
        """
        Replaces the CronJobList in the currently
        configured Kubernetes cluster and returns a boolean indicating whether
        or not the CronJobList was actually replaced.
        """
        try:
            _kube_api.replace_resource(self, namespace=namespace)
            return True
    ...
    def delete_resource(self, namespace: 'str' = None) -> bool:
        """
        Deletes the CronJobList from the currently
        configured Kubernetes cluster and returns the status information
        returned by the Kubernetes API in response to the delete action.
        """
        try:
