...
from kuber.v1_33.core_v1 import TypedLocalObjectReference  # noqa: F401
...
class IPAddress(_kuber_definitions.Resource):
    ...
    def __init__(
        ...
        super(IPAddress, self).__init__(api_version="networking/v1", kind="IPAddress")
        self._properties = {
...
class IPAddressList(_kuber_definitions.Collection):
    ...
    def __init__(
        ...
        super(IPAddressList, self).__init__(
            api_version="networking/v1", kind="IPAddressList"
        )
        self._properties = {
...
class IPAddressSpec(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(IPAddressSpec, self).__init__(
            api_version="networking/v1", kind="IPAddressSpec"
        )
        self._properties = {
...
class ParentReference(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(ParentReference, self).__init__(
            api_version="networking/v1", kind="ParentReference"
        )
        self._properties = {
...
class ServiceCIDR(_kuber_definitions.Resource):
    ...
    def __init__(
        ...
        super(ServiceCIDR, self).__init__(
            api_version="networking/v1", kind="ServiceCIDR"
        )
        self._properties = {
            "metadata": metadata if metadata is not None else ObjectMeta(),
...
class ServiceCIDRList(_kuber_definitions.Collection):
    ...
    def __init__(
        ...
        super(ServiceCIDRList, self).__init__(
            api_version="networking/v1", kind="ServiceCIDRList"
        )
        self._properties = {
            "items": items if items is not None else [],
            "metadata": metadata if metadata is not None else ListMeta(),
...
class ServiceCIDRSpec(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(ServiceCIDRSpec, self).__init__(
            api_version="networking/v1", kind="ServiceCIDRSpec"
        )
        self._properties = {
...
class ServiceCIDRStatus(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(ServiceCIDRStatus, self).__init__(
            api_version="networking/v1", kind="ServiceCIDRStatus"
        )
        self._properties = {
