...
from kuber.v1_33.core_v1 import EventSource  # noqa: F401
...
class EventSeries(_kuber_definitions.Definition):
    ...
    thing that was/is happening continuously for some time. How
    often to update the EventSeries is up to the event
    reporters. The default event reporter in "k8s.io/client-
    go/tools/events/event_broadcaster.go" shows how this struct
    ...
    def __init__(
        ...
        super(EventSeries, self).__init__(api_version="events/v1", kind="EventSeries")
        self._properties = {
