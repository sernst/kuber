...
class LeaseCandidate(_kuber_definitions.Resource):
    ...
    def __init__(
        ...
        super(LeaseCandidate, self).__init__(
            api_version="coordination/v1alpha2", kind="LeaseCandidate"
        )
        self._properties = {
    ...
    def get_resource_api(
    ...
    ) -> "client.CoordinationV1alpha2Api":
        """
        ...
        return client.CoordinationV1alpha2Api(**kwargs)
...
class LeaseCandidateList(_kuber_definitions.Collection):
    ...
    def __init__(
        ...
        super(LeaseCandidateList, self).__init__(
            api_version="coordination/v1alpha2", kind="LeaseCandidateList"
        )
        self._properties = {
...
class LeaseCandidateSpec(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(LeaseCandidateSpec, self).__init__(
            api_version="coordination/v1alpha2", kind="LeaseCandidateSpec"
        )
        self._properties = {
