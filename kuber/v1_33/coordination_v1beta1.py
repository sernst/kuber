...
from kuber.v1_33.meta_v1 import MicroTime  # noqa: F401
...
class LeaseCandidate(_kuber_definitions.Resource):
    ...
    def __init__(
        ...
        super(LeaseCandidate, self).__init__(
            api_version="coordination/v1beta1", kind="LeaseCandidate"
        )
        self._properties = {
...
class LeaseCandidateList(_kuber_definitions.Collection):
    ...
    def __init__(
        ...
        super(LeaseCandidateList, self).__init__(
            api_version="coordination/v1beta1", kind="LeaseCandidateList"
        )
        self._properties = {
...
class LeaseCandidateSpec(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(LeaseCandidateSpec, self).__init__(
            api_version="coordination/v1beta1", kind="LeaseCandidateSpec"
        )
        self._properties = {
    ...
    def binary_version(self) -> str:
        ...
        format without leading `v`. This field is required.
        """
        return typing.cast(
            str,
    ...
    def lease_name(self) -> str:
        ...
        is contending. The limits on this field are the same as on
        Lease.name. Multiple lease candidates may reference the same
        Lease.name. This field is immutable.
        """
        return typing.cast(
            str,
    ...
    def strategy(self) -> str:
        """
        Strategy is the strategy that coordinated leader election
        will use for picking the leader. If multiple candidates for
        the same Lease return different strategies, the strategy
        provided by the candidate with the latest BinaryVersion will
        be used. If there is still conflict, this is a user error
        and coordinated leader election will not operate the Lease
        until resolved.
        """
        return typing.cast(
            str,
