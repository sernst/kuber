...
from kuber.latest.authentication_v1 import UserInfo  # noqa: F401
...
class SelfSubjectReview(_kuber_definitions.Resource):
    ...
    def __init__(
        ...
        super(SelfSubjectReview, self).__init__(
            api_version="authentication/v1alpha1", kind="SelfSubjectReview"
        )
        self._properties = {
    ...
    def get_resource_api(
        ...
        return client.AuthenticationV1alpha1Api(**kwargs)
...
class SelfSubjectReviewStatus(_kuber_definitions.Definition):
    ...
    def __init__(
        ...
        super(SelfSubjectReviewStatus, self).__init__(
            api_version="authentication/v1alpha1", kind="SelfSubjectReviewStatus"
        )
        self._properties = {
